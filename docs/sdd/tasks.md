...
- [x] [P] Implementar hook useGroups() para listar grupos
  - **MDD:** §2.1
  - **Archivo:** `apps/web/src/hooks/useGroups.ts`

- [x] [P] Implementar hook useParticipants() para listar participantes
  - **MDD:** §2.1
  - **Archivo:** `apps/web/src/hooks/useParticipants.ts`

- [x] [P] Implementar hook useHistory() para listar historial
  - **MDD:** §2.1
  - **Archivo:** `apps/web/src/hooks/useHistory.ts`

- [x] [P] Responsive: en viewport < md, tablas de tickets/grupos/historial se muestran como cards apiladas
  - **MDD:** UI/UX Design Intent
  - **Archivo:** `apps/web/src/components/TicketList.tsx` (responsive)

- [x] [P] Touch targets ≥ 44×44px en todos los botones y enlaces
  - **MDD:** UI/UX Design Intent
